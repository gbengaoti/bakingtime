...
public class VideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView mVideoPlaceholderImageView = (ImageView) view.findViewById(R.id.no_video_placeholder);
        TextView mTextDescriptionView = (TextView) view.findViewById(R.id.text_video_step);
    ...
    private void initializePlayer(String videoURL) {
        ...
        if (!(videoURL.equals(""))) {
            ...
            TrackSelection.Factory mVideoTrackSelectionFactory = new AdaptiveVideoTrackSelection.Factory(mBandwidthMeter);
